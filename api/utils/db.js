// // /**
// //  * Vercel KV (Redis) Database Utilities
...
// //  * @param {string} email - The user's email
// //  * @returns {string} Referral code (e.g., "JANE-SMITH-X7K")
// //  */
...
//  * Generate a unique referral code from email
//  * @param {string} email - The user's email
//  * @returns {string} Referral code (e.g., "JANE-X7K")
//  */
// function generateReferralCode(email) {
//   const name = email
//     .split("@")[0]
